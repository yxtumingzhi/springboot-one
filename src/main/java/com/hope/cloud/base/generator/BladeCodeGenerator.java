...
import com.hope.one.utils.Func;
...
public class BladeCodeGenerator {
     ...
     * 代码所在系统
     */
    private String systemName = SystemConstant.HOPE_CLOUD_NAME;
    /**
     * 代码模块名称
     */
     ...
     * 代码生成的包名
     */
    private String packageName = "com.hope.cloud";
    /**
     * 代码后端生成的地址
     */
    ...
    private InjectionConfig getInjectionConfig() {
        ...
        if (Func.isNotBlank(packageWebDir)) {
            if (Func.equals(systemName, SystemConstant.HOPE_CLOUD_NAME)) {
            ...
            } else if (Func.equals(systemName, SystemConstant.HOPE_CLOUD_NAME)) {
