...
class ElasticsearchApplicationTests {
    ...
    void checkIndex() {
        ...
        checkIndexExists(Article.Author.class);
    }
    ...
    void deleteIndex() {
        ...
        _deleteIndex(Article.Author.class);
    }

    @Test
    void save() {
        Article article = new Article("Spring Data Elasticsearch");
        article.setAuthors(asList(new Article.Author("LaoAlex"), new Article.Author("John")));
        articleRepository.save(article);

        article = new Article("Spring Data Elasticsearch2");
        article.setAuthors(asList(new Article.Author("LaoAlex"), new Article.Author("King")));
        articleRepository.save(article);

        article = new Article("Spring Data Elasticsearch3");
        article.setAuthors(asList(new Article.Author("LaoAlex"), new Article.Author("Bill")));
        articleRepository.save(article);
    }
